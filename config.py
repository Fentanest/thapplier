...
REDEEM_BUTTON_CONFIRM = '//div[contains(@class, "convert-key-confirm")]//button[normalize-space(text())="교환하기"]'
CANCEL_BUTTON = '//div[contains(@class, "el-dialog__wrapper")]//button[span[text()="취소"]]'
